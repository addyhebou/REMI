  ...
  'Music Creator': {
    Tasks: {
      'Sharpen YOUR Sound': {
        ...
        'SMART Goal':
          "Remake at least 3 Songs from each 6 albums: After Hours & Starboy (The Weeknd), Coloring Book (Chance the Rapper), Voicenotes (Charlie Puth), Hollywood's Bleeding & Beerbongs and Bentleys (Post Malone)",
      },
      ...
      'Top-40 Producer': {
        ...
        'SMART Goal':
          'Get Both Nate Fox and [Andrew Goldstein or Louis Bell] as Summer Mentors',
      },
      'Producer Brand': {
        Steps: [
      ...
      'Industry Level Up': {
        ...
        'SMART Goal':
          'Land on New Music Friday, get a publishing deal offer, release at least 10 songs, and produce 2 major artists',
      },
    },
  },
  ...
  'Personal Goals': {
    Tasks: {
      'At-Work Ethic': {
        ...
        'SMART Goal':
          'Receive job re-offers from every company I work with for the next available term',
      },
      'Good Sleep': {
        Steps: [
      ...
      'Mental Health': {
        ...
        'SMART Goal':
          'Truthfully state words of affirmation on beauty, self-worth, abilities, and my current life',
      },
      Miina: {
